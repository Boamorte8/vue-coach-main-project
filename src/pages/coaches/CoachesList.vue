<template>
  <div>
    ...
    <section>
      <coach-filter @changeFilter="changeFilter"></coach-filter>
    </section>
    <section>
      <base-card>
        <div class="controls">
...
export default {
  ...
  computed: {
    filteredCoaches() {
      ...
      return coaches.filter(coach => {
        ...
        //   return coach.areas.includes(filter);
        // });
      });
    },
    hasCoaches() {
  ...
  methods: {
    changeFilter(updatedFilters) {
      // this.activeFilters = Object.keys(updatedFilters).filter(filter => !!updatedFilters[filter]);
